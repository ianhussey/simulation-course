...
dir.create("causal_models_plots")

# bivariate correlation
pdf(file = "causal_models_plots/1_bivariate_correlation.pdf", width = 6, height = 5)
...
# simple regression
pdf(file = "causal_models_plots/2_simple_regression.pdf", width = 6, height = 5)
...
# simple regression reversed causation
pdf(file = "causal_models_plots/3_simple_regression_reversed.pdf", width = 6, height = 5)
...
# network
pdf(file = "causal_models_plots/4_network_of_correlations.pdf", width = 6, height = 5)
...
# multiple regression
pdf(file = "causal_models_plots/5_multiple_regression.pdf", width = 6, height = 5)
...
# mediation
pdf(file = "causal_models_plots/6_mediation.pdf", width = 6, height = 5)
...
# confounder
pdf(file = "causal_models_plots/7_confounder.pdf", width = 6, height = 5)
...
# collider 
pdf(file = "causal_models_plots/8_collider.pdf", width = 6, height = 5)
...
ggsave("causal_models_multiple_causal_models_one_analysis.pdf",
       width = 6,
       height = 4)
