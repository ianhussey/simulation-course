...
BDI-II data taken from Cataldo et al. (2022) "Abnormal Evidence Accumulation Underlies the Positive Memory Deficit in Depression" doi https://doi.org/10.1037/xge0001268
...
ggplot(simulated_data, aes(x = x, y = y)) +
  ...
  theme_linedraw() +
  annotate("text", x = Inf, y = Inf, label = paste("r =", round(full_correlation, 2)), 
...
ggplot(simulated_data_range_restricted, aes(x = x, y = y)) +
  ...
  theme_linedraw() +
  annotate("text", x = Inf, y = Inf, label = paste("r =", round(restricted_correlation, 2)), 
